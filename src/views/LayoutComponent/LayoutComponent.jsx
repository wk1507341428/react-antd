...
import Editor from '../Other/xmindEditor/xmindEditor'
import UploadCompontent from '../Other/Upload/Upload'
// 组件
        ...
        <Layout>
            ...
            <Menu theme="dark" mode="inline" 
              ...
              <SubMenu key="/other" title={<span><Icon type="facebook" /><span>其他展示</span></span>}>
                  <Menu.Item key="/other/Form">
                    <Link to={{pathname:'/other/Form'}} replace>表单</Link>
                  </Menu.Item>
                  <Menu.Item key="/other/Page2">
                    <Link to={{pathname:'/other/Page2'}} replace>不知道叫什么2</Link>
                  </Menu.Item>
                  <Menu.Item key="/other/editor">
                    <Link to={{pathname:'/other/editor'}} replace>文本编辑器</Link>
                  </Menu.Item>
                  <Menu.Item key="/other/upload">
                    <Link to={{pathname:'/other/upload'}} replace>上传</Link>
                  </Menu.Item>
              </SubMenu>              
            </Menu>
          </Sider>
          <Layout>
            ...
            <Content style={{ margin: '0px 16px 24px 16px', padding: 24, background: '#fff', minHeight: 280 }}>
              ...
              <Route path="/other/editor" component={Editor} />
              <Route path="/other/upload" component={UploadCompontent} />
            </Content>
          </Layout>
        </Layout>
      </div>
